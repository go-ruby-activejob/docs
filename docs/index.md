# go-ruby-activejob documentation

**Pure-Go, MRI-4.0.5-faithful Ruby activejob (no cgo)**

`go-ruby-activejob/activejob` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `activejob`,
matching reference Ruby (MRI) behaviour. The module path is
`github.com/go-ruby-activejob/activejob`.
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `activejob`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`activejob`](https://github.com/go-ruby-activejob/activejob) | the library — Ruby's `activejob` in pure Go |
| [`docs`](https://github.com/go-ruby-activejob/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-activejob.github.io`](https://github.com/go-ruby-activejob/go-ruby-activejob.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-activejob/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-activejob/activejob](https://github.com/go-ruby-activejob/activejob).
