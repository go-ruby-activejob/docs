...
The public API lives at the module root (`github.com/go-ruby-activejob/activejob`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `activejob`, while the surface follows
...
```go
import "github.com/go-ruby-activejob/activejob"
```
...
- **[pkg.go.dev/github.com/go-ruby-activejob/activejob](https://pkg.go.dev/github.com/go-ruby-activejob/activejob)**

The module's [README](https://github.com/go-ruby-activejob/activejob#readme) carries worked
